...
def create_profiles_json(profiles_dir: str = "bot_keydrop/profiles", output_file: str = "profiles.json", default_proxy: str = "") -> List[Dict[str, str]]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", default="bot_keydrop/profiles", help="Profiles directory")
